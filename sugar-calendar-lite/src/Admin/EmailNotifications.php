...
class EmailNotifications {
	...
	public function enqueue_assets( $page ) {
		...
		$asset_file_path = SC_PLUGIN_DIR . 'assets/jsx/build/admin/email-notifications.asset.php';

		// The manifest is generated by the JSX build (`npm run gulp jsx`) and is
		// absent on a source-only checkout until assets are built.
		if ( $this->page_has_sidebar() && file_exists( $asset_file_path ) ) {
