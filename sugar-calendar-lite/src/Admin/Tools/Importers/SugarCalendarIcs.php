		...
		<p>
			...
			echo wp_kses(
				sprintf(
					...
					__(
						'Import events from your Apple, Google, Microsoft, or other calendars. Run a one-time import, or set a schedule that keeps them up to date automatically. <a target="_blank" href="%1$s">Upgrade to Sugar Calendar Pro</a>.',
						'sugar-calendar-lite'
					),
					$description_utm
				),
