<?php
/**
 * Events: Sugar_Calendar\AddOn\Ticketing\Database\Ticket_Query class
 *
 ...
 * @since 1.0
 *
 * @see Ticket_Query::__construct() for accepted arguments.
 */
final class Discount_Query extends Query {
